...
,   m_modelInfoPath(_modelInfoPath == "." ? _name : _modelInfoPath + "." + _name)
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
Model::subscribe(Helmet::Core::Event::I_Observer& _observer) const
{
    ...
    BOOST_LOG_TRIVIAL(trace) << "[" << getName() << "] : Subscribing [" << _observer.getName() << "]";
    auto evt = Event(*this);
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
Model::signal(Helmet::Core::Event::I_Event& _event) const
{
    BOOST_LOG_TRIVIAL(trace) << "[" << getName() << "] : Issuing " << _event.getType() << " update event.";
    m_signal(_event);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Helmet::Workbench::I_Model::pEnvironment_type
Model::getEnvironment() const
{
    return m_pEnvironment;
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Model::Event::Event(const I_Observable& _source)
:   m_source(_source)
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
const std::string&
Model::Event::getType() const
{
    static std::string sm_type("model");
    return sm_type;
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
const Helmet::Core::Event::I_Observable&
Model::Event::getSource() const
{
    return m_source;
}
