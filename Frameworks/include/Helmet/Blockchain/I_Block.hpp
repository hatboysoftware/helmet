...
public:
    ...
    /// @{
public:
    virtual boost::uint64_t getIndex() const = 0;
    virtual const std::string &getPreviousHash() const = 0;
    virtual boost::uint64_t getTimestamp() const = 0;
    virtual boost::uint64_t getNonce() const = 0;
    virtual const I_BlockPayload& getPayload() const = 0;
