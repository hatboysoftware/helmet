...
class HELMET_ENTERPRISE_DLL_LINK I_ProtocolServicePlugin
...
public:
    ...
    /// @{
public:
    virtual pProtocolService_type getProtocolService(Enterprise::I_ApplicationServer& _applicationServer,
    ...
    /// @{
protected:
             I_ProtocolServicePlugin();
    virtual ~I_ProtocolServicePlugin();
    /// @}

};  // interface I_ProtocolServicePlugin
